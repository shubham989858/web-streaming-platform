...
export const stripeSubscriptionStatusEnum = pgEnum("stripe_subscription_status", ["none", "incomplete", "incomplete_expired", "trialing", "active", "past_due", "canceled", "unpaid", "paused"])
...
export const users = pgTable("users", {
    ...
    stripeSubscriptionStatus: stripeSubscriptionStatusEnum("stripe_subscription_status").notNull().default("none"),
